...
#                 attempts_left -= 1
#             else:
#                 print("No more hints available. All letters have been revealed.")
#             # Check if the word is fully guessed after the hint
#             if set(word) <= guessed_letters:
#                 print(f"\nCongratulations! You guessed the word: '{word}'")
#                 return
...
#         print(f"Attempts left: {attempts_left}")
#
#         guess = input("Guess a letter or type 'hint' for a hint (using hint will cost you a attempt): ").lower()
...
#
#         if guess == 'hint':
#             # print(f"Using hint will cost you a attempt")
#             print(f"Hint: The word starts with '{word[0]}' and has {len(word)} letters.")
#             attempts_left -= 1
#             continue
#
#         if guess in guessed_letters:
